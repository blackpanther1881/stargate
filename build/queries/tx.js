...
function setupTxExtension(base) {
    ...
    return {
        tx: {
            getTx: function (txId) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, queryService.GetTx(request)];
                        case 1:
                            response = _a.sent();
            ...
            simulate: function (messages, memo, signer, sequence) { return __awaiter(_this, void 0, void 0, function () {
                var request, response;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, queryService.Simulate(request)];
                        case 1:
                            response = _a.sent();
                            return [2 /*return*/, response];
                    }
